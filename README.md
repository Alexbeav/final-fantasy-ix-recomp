# Final Fantasy IX Recompiled

This release candidate uses PSXRecomp and the shared recomp-ui launcher.
You must supply your own SLUS-01251 game disc and SCPH-5502/5552 Europe BIOS.
...
2. Start `Final_Fantasy_IX_Recompiled` (`.exe` on Windows).
