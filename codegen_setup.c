...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Final Fantasy IX",
    .project_root_env = "FINAL_FANTASY_IX_PROJECT_ROOT",
    .build_dir_env = "FINAL_FANTASY_IX_BUILD_DIR",
    .force_setup_env = "FINAL_FANTASY_IX_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_012.51_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Final_Fantasy_IX_Recompiled",
    .prepare_note =
